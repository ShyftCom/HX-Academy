...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} style={{ color: "var(--text-primary)" }} className={cn("text-lg font-semibold", className)} {...props} />
  )
);
...
const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p ref={ref} style={{ color: "var(--text-muted)" }} className={cn("text-sm", className)} {...props} />
  )
);
